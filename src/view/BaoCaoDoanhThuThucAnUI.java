 ...
 * @author admin
 */
public class BaoCaoDoanhThuThucAnUI extends javax.swing.JFrame {

    /**
     * Creates new form BaoCaoDoanhThuThucAn
     */
    public BaoCaoDoanhThuThucAnUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã thức ăn", "Tên thức ăn", "Loại thức ăn", "Doanh thu", "", "", ""
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaoCaoDoanhThuThucAnUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaoCaoDoanhThuThucAnUI().setVisible(true);
            }
        });
    }
