 ...
 * @author admin
 */
public class BaoCaoDoanhThuKhachHang extends javax.swing.JFrame {

    /**
     * Creates new form BaoCaoDoanhThuKhachHang
     */
    public BaoCaoDoanhThuKhachHang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaoCaoDoanhThuKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaoCaoDoanhThuKhachHang().setVisible(true);
            }
        });
    }
