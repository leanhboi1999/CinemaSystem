 ...
 * @author admin
 */
public class BanThucAn extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BanThucAn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
