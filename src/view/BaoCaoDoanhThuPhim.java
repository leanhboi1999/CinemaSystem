 ...
 * @author admin
 */
public class BaoCaoDoanhThuPhim extends javax.swing.JFrame {

    /**
     * Creates new form BaoCaoDoanhThuPhim
     */
    public BaoCaoDoanhThuPhim() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaoCaoDoanhThuPhim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaoCaoDoanhThuPhim().setVisible(true);
            }
        });
    }
