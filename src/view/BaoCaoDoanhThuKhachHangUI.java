 ...
 * @author admin
 */
public class BaoCaoDoanhThuKhachHangUI extends javax.swing.JFrame {

    /**
     * Creates new form BaoCaoDoanhThuKhachHang
     */
    public BaoCaoDoanhThuKhachHangUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã khách hàng", "Họ và tên", "Ngày đăng ký", "Loại khách hàng", "Doanh thu", "", ""
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaoCaoDoanhThuKhachHangUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaoCaoDoanhThuKhachHangUI().setVisible(true);
            }
        });
    }
